(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.grace, 100, 500, 7, 0.9);
        collectable.create(type.kennedi, 400, 10, 4, 0,2);
        collectable.create(type.max, 600, 100, 2, 0.5);
        collectable.create(type.db, 300, 700, 9, 0.4);
